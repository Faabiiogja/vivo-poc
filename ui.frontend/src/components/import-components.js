...
MapTo('vivopoc/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('vivopoc/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('vivopoc/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('vivopoc/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('vivopoc/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('vivopoc/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('vivopoc/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('vivopoc/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('vivopoc/components/navigation')(NavigationV1);
MapTo('vivopoc/components/languagenavigation')(LanguageNavigationV1);


MapTo('vivopoc/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('vivopoc/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('vivopoc/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('vivopoc/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
